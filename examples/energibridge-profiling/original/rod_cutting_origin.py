...
# Usage: python floyd_warshall_experiment.py /tmp/out.txt
import os
import sys
import time
import random
...
if __name__ == "__main__":
    ...
    # Tunables via environment variables (defaults match your example)
    ...
    base_graph = make_random_graph(n, density, w_min=w_min, w_max=w_max, seed=seed)
